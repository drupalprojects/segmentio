...
By installing Analytics.js's Drupal plugin you can add any analytics service to 
...
Installation
------------
 * Install as usual, Copy the 'Analytics.js' module directory in to your Drupal,
